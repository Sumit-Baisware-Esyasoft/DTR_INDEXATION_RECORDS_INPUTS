...
def load_hierarchy_data():
    try:
        hierarchy_path = r"DTR Master Information_2.xlsx"
...
st.markdown(f"Last Update ({datetime.datetime.now().strftime('%d-%m-%Y %I:%M %p')}) - {hierarchy_df['Msn'].shape[0]} Records Found")
